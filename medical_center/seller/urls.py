...
urlpatterns = [
    ...
    path(
        "create_comment_seller/",
        CreateCommentSellerAPIView.as_view(),
        name="create_comment_seller",
    ),
    path(
        "update_comment_seller/<str:title>/",
        UpdateCommentSellerAPIView.as_view(),
        name="update_comment_seller",
    ),
    path(
