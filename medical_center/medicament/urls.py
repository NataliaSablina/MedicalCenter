...
urlpatterns = [
    ...
    path('categories/update/medicament/category/<str:title>/', MedicamentCategoryView.as_view(),
         name='update-medicament-category'),
    path('current/category/medicament/<str:title>/', CurrentCategoryMedicamentListAPIView.as_view(),
         name='current-category-medicament'),
    path('current/medicament/<str:title>/', CurrentMedicamentListAPIView.as_view(),
